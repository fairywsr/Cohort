...
// Example: If a product costs $1000 and a 10% discount is applied, the new price
// should be $900.
// 2. purchase(quantity)
// o If the requested quantity is available in stock, reduce the stock accordingly.
// o If not enough stock is available, return "Not enough stock".
...
function Rroduct(product, price, stock){
    this.product = product;
    this.price = price;
    this.stock = stock
}

Product.prototype.getDiscounr = function(percent){
